        ...
        <div className="relative isolate bg-terceira px-6 pt-16 sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-10 lg:pt-0">
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
              <a
                href="/FormFeedback"
                className="rounded-md bg-[#B7D4DA] px-3.5 py-2.5 text-lg font-sen text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white w-[40%] flex justify-center"
              >
                Get started
              </a>
